...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( AuthStateInitial value)?  initial,TResult Function( AuthStateLoading value)?  loading,TResult Function( AuthStateError value)?  error,TResult Function( AuthStateSuccess value)?  success,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
return error(_that);case AuthStateSuccess() when success != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( AuthStateInitial value)  initial,required TResult Function( AuthStateLoading value)  loading,required TResult Function( AuthStateError value)  error,required TResult Function( AuthStateSuccess value)  success,}){
final _that = this;
switch (_that) {
case AuthStateInitial():
return initial(_that);case AuthStateLoading():
return loading(_that);case AuthStateError():
return error(_that);case AuthStateSuccess():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( AuthStateInitial value)?  initial,TResult? Function( AuthStateLoading value)?  loading,TResult? Function( AuthStateError value)?  error,TResult? Function( AuthStateSuccess value)?  success,}){
final _that = this;
switch (_that) {
case AuthStateInitial() when initial != null:
return initial(_that);case AuthStateLoading() when loading != null:
...
return error(_that.message);case AuthStateSuccess() when success != null:
...
return error(_that.message);case AuthStateSuccess():
return success();}
}
...
class AuthStateError extends AuthState {
  const AuthStateError(this.message): super._();
...
class AuthStateSuccess extends AuthState {
  const AuthStateSuccess(): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AuthStateSuccess);
}
